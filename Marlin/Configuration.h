...
#define STRING_CONFIG_H_AUTHOR "(Mark Twombley, Ender-3)" // Who made the changes.
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44.2, -3.10, -0.63 }
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_INSET_LFRB { 35, 30, 45, 30 } // (mm) Left, Front, Right, Back insets
